...
// TÓPICO
export const LOADING_TOPICO = 'LOADING_TOPICO'
export const TOPICO_LOADED = 'TOPICO_LOADED'
export const SET_TOPICO = 'SET_TOPICO'
...
// TEXTOS
export const LOADING_TEXTOS = 'LOADING_TEXTOS'
export const TEXTOS_LOADED = 'TEXTOS_LOADED'
export const SET_TEXTOS = 'SET_TEXTOS'